...
//     {
//       id: 2,
//       title: "Signa Group of College",
//       date: "2025-10-30",
//       time: "2:00 PM - 4:00 PM ",
//       duration: "2 hours",
//       status: "upcoming",
//       participants: "250+",
//       description: "Hands-On AI Workshop : Running LLM (ChatGPT) Offline using RunAnyWhere .",
//       formLink: "https://forms.gle/DKfBwDmvuNLJEaVv6" 
//     },
//     {
//       id: 3,
//       title: "Rama University Kanpur",
//       date: "2025-10-30",
...
//     {
//       id: 6,
//       title: "Harcourt Butler Technical University , Kanpur",
//       date: "2025-11-07",
...
//     {
//       id: 7,
//       title: "Vision Group of Institution , Kanpur",
//       date: "2025-10-27",
//       time: "10:00 AM - 12:00 PM ",
//       duration: "2 hours",
//       status: "completed",
...
//                    <Clock className="w-7 h-7 text-orange-600" />
//                   <span className="text-red-700 font-semibold">Upcoming Sessions</span>
//                 </div>
...
function Session() {
  ...
  // ✅ Automatically update session status based on date
  useEffect(() => {
    const today = new Date();

    const isPastDate = (dateStr) => {
      if (!dateStr || dateStr.toLowerCase().includes("depend") || dateStr.toLowerCase().includes("pending")) {
        return false;
      }
    ...
    const updated = sessions.map((session) =>
      isPastDate(session.date) ? { ...session, status: "completed" } : session
    );
